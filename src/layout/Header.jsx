    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-6 lg:space-x-12">
          <Link
            href="/"
            className="text-[#ED2236] font-bold text-sm lg:text-base transition-colors duration-200"
          >
            HOME
          </Link>
          <a
            href="/about-us"
            className="text-black hover:text-[#ED2236] font-bold text-sm lg:text-base transition-colors duration-200"
          >
            ABOUT US
          </a>
          <a
