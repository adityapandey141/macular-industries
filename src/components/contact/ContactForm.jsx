...
const ContactForm = () => {
  ...
  return (
    <div className="w-full px-4 sm:px-6 lg:px-8 ">
      <div className=" max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 p-4 sm:p-6 bg-white rounded-lg shadow-md shadow-black/20 mt-10 mb-[30px]">
          ...
          {status.submitted ? (
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                ...
                className={`w-full sm:w-auto bg-[#ED2236] hover:bg-[#16171A] text-white font-medium py-2 sm:py-3 px-4  rounded transition-all duration-300 hover:shadow-md cursor-pointer ${
