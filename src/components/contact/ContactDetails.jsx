      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6 ">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 sm:gap-8">
          ...
          <div className="flex flex-col items-center text-center px-4">
            ...
            <h3 className="text-base sm:text-xl font-medium text-black ">Address</h3>
          ...
          <div className="flex flex-col items-center text-center px-4">
            ...
            <h3 className="text-base sm:text-xl font-medium text-black mb-2">Phone</h3>
            <p className="text-gray-900 text-sm sm:text-lg mt-1">+91 93764 50829</p>
          </div>
