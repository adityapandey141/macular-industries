    ...
    <div className="w-full">
      <div className="relative h-[450px] sm:h-[550px] md:h-[80vh] bg-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto flex flex-col items-center justify-center md:flex-row md:items-center md:justify-between h-full px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-black w-full  text-center md:text-left space-y-4 sm:space-y-6">
            <h1
              className="text-[8vw] sm:text-5xl md:text-6xl font-bold whitespace-nowrap"
              data-aos="fade-up"
              data-aos-delay="30"
            ...
            <p
              className="text-gray-800 text-base sm:text-lg md:text-xl leading-relaxed sm:leading-loose max-w-2xl mx-auto md:mx-0"
              data-aos="fade-up"
              data-aos-delay="30"
            ...
            <div className="flex justify-center md:justify-start">
              <a href="/product">
                <button
                  className="bg-[#ED2236] hover:bg-[#16171A] text-white font-medium py-4 px-4 rounded transition-all duration-300 hover:shadow-md cursor-pointer"
                  data-aos="fade-up"
                  data-aos-delay="30"
