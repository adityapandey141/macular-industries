    ...
    <section className="py-12 sm:py-16 bg-gray-50 ">
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6">
        <div className="text-center mb-10 sm:mb-14">
          <p
            className="text-sm sm:text-base text-grey-600 "
            data-aos="fade-up"
            data-aos-delay="30"
          ...
          {teamMembers.map((member) => (
            ...
            >
              <div className="flex justify-center mt-6">
                <div
                  className="relative w-20 h-20 sm:w-30 sm:h-30 rounded-full overflow-hidden border-4 border-white shadow-md"
                  data-aos="fade-up"
                  data-aos-delay="30"
                  data-aos-duration="900"
                  data-aos-easing="ease-in-out"
              ...
              <div className="p-4 sm:p-6 text-center">
                ...
                <p
                  className="text-grey-800 text-sm sm:text-base  mt-1"
                  data-aos="fade-up"
                  data-aos-delay="30"
